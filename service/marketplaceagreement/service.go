...
// MarketplaceAgreement provides the API operation methods for making requests to
// AWS Marketplace Agreement Service. See this package's package overview docs
// for details on the service.
//
// MarketplaceAgreement methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *MarketplaceAgreement {
	svc := &MarketplaceAgreement{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a MarketplaceAgreement operation and runs any
// custom request initialization.
func (c *MarketplaceAgreement) newRequest(op *request.Operation, params, data interface{}) *request.Request {
