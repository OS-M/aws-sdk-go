...
// New creates a new instance of the Chatbot client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *Chatbot {
	svc := &Chatbot{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a Chatbot operation and runs any
// custom request initialization.
func (c *Chatbot) newRequest(op *request.Operation, params, data interface{}) *request.Request {
