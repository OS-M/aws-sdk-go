...
// MarketplaceDeployment provides the API operation methods for making requests to
// AWS Marketplace Deployment Service. See this package's package overview docs
// for details on the service.
//
// MarketplaceDeployment methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the MarketplaceDeployment client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *MarketplaceDeployment {
	svc := &MarketplaceDeployment{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a MarketplaceDeployment operation and runs any
// custom request initialization.
func (c *MarketplaceDeployment) newRequest(op *request.Operation, params, data interface{}) *request.Request {
