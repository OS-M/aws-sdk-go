...
// New creates a new instance of the CleanRoomsML client with a session.
...
func New(p client.ConfigProvider, cfgs ...*aws.Config) *CleanRoomsML {
	...
	if c.SigningNameDerived || len(c.SigningName) == 0 {
		c.SigningName = "cleanrooms-ml"
	}
	return newClient(*c.Config, c.Handlers, c.PartitionID, c.Endpoint, c.SigningRegion, c.SigningName, c.ResolvedRegion)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *CleanRoomsML {
	svc := &CleanRoomsML{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a CleanRoomsML operation and runs any
// custom request initialization.
func (c *CleanRoomsML) newRequest(op *request.Operation, params, data interface{}) *request.Request {
