...
// TaxSettings provides the API operation methods for making requests to
// Tax Settings. See this package's package overview docs
// for details on the service.
//
// TaxSettings methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *TaxSettings {
	svc := &TaxSettings{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a TaxSettings operation and runs any
// custom request initialization.
func (c *TaxSettings) newRequest(op *request.Operation, params, data interface{}) *request.Request {
