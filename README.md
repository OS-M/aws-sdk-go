...
[![API Reference](https://img.shields.io/badge/api-reference-blue.svg)](https://docs.aws.amazon.com/sdk-for-go/api) [![Join the chat at https://gitter.im/aws/aws-sdk-go](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/aws/aws-sdk-go?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) [![Build status](https://github.com/OS-M/aws-sdk-go/actions/workflows/go.yml/badge.svg?branch=main)](https://github.com/OS-M/aws-sdk-go/actions/workflows/go.yml) [![Apache V2 License](https://img.shields.io/badge/license-Apache%20V2-blue.svg)](https://github.com/OS-M/aws-sdk-go/blob/main/LICENSE.txt)
...
Use `go get` to retrieve the SDK to add it to your project's Go module dependencies.
	...
	go get github.com/OS-M/aws-sdk-go

To update the SDK use `go get -u` to retrieve the latest version of the SDK.

	go get -u github.com/OS-M/aws-sdk-go
...
* If you think you may have found a bug, please open an [issue](https://github.com/OS-M/aws-sdk-go/issues/new/choose).
...
Search the [existing issues](https://github.com/OS-M/aws-sdk-go/issues) and see
...
in the [Getting Help](https://github.com/OS-M/aws-sdk-go#getting-help) section.
...
[SDK Examples](https://github.com/OS-M/aws-sdk-go/tree/main/example) -
...
[issues]: https://github.com/OS-M/aws-sdk-go/issues
[pr]: https://github.com/OS-M/aws-sdk-go/pulls
